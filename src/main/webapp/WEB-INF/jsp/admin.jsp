                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li class="media mb-3">
                                                ...
                                                <div class="media-body pl-3">
                                                    <p class="font-md text-muted mb-1">Your listing <a href="#"
                                                                                                       class="font-weight-bold">A1
                                                        Mall</a> has been approved.</p>
                                            ...
                                            <li class="media mb-3">
                                                ...
                                                <div class="media-body pl-3">
                                                    <p class="font-md text-muted mb-1">Someone bookmark your <a href="#"
                                                                                                                class="font-weight-bold">First
                                                        dating cafe</a> listing.</p>
                                            ...
                                            <li class="media mb-3">
                                                ...
                                                <div class="media-body pl-3">
                                                    <p class="font-md text-muted mb-1"><a href="#"
                                                                                          class="font-weight-bold">Herris</a>
                                                        gives 5 star rating on <a href="#" class="font-weight-bold">Good
                                                            Restaurant</a></p>
                                            ...
                                            <li class="media mb-3">
                                                ...
                                                <div class="media-body pl-3">
                                                    <p class="font-md text-muted mb-1"><a href="#"
                                                                                          class="font-weight-bold">Paige
                                                        Turner</a> bookmark your <a href="#" class="font-weight-bold">Alpha
                                                        Muscle Center</a> listing</p>
                                                    <span class="d-block font-sm text-muted">1 day ago</span>
                                                </div>
                                            </li>
                                            <li class="media">
                                                ...
                                                <div class="media-body pl-3">
                                                    <p class="font-md text-muted mb-1">Someone gives 5 star rating on <a
                                                            href="#" class="font-weight-bold">Continental Hotel</a></p>
                                        ...
                                        <ul class="list-unstyled data--list">
                                            <li class="data--list__item">
                                                <div class="data--list__item-content">
                                                    <p class="mb-1"><a href="invoice.html"
                                                                       class="font-weight-bold text-truncate">Mario
                                                        Speedwagon</a></p>
                                                ...
                                                <div class="dropdown">
                                                    <a class="icon-sm" href="javascript:void(0);" data-toggle="dropdown"
                                                       aria-haspopup="true" aria-expanded="false"><i
                                                            class="ion-md-more"></i></a>
                                            ...
                                            <li class="data--list__item">
                                                <div class="data--list__item-content">
                                                    <p class="mb-1"><a href="invoice.html"
                                                                       class="font-weight-bold text-truncate">Petey
                                                        Cruiser</a></p>
                                                    <ul class="list-unstyled data--list__item-content__info">
                                            ...
                                            <li class="data--list__item">
                                                <div class="data--list__item-content">
                                                    <p class="mb-1"><a href="invoice.html"
                                                                       class="font-weight-bold text-truncate">Anna
                                                        Sthesia</a></p>
                                                    <ul class="list-unstyled data--list__item-content__info">
                                            ...
                                            <li class="data--list__item">
                                                <div class="data--list__item-content">
                                                    <p class="mb-1"><a href="invoice.html"
                                                                       class="font-weight-bold text-truncate">Paul
                                                        Molive</a></p>
                                                    <ul class="list-unstyled data--list__item-content__info">
