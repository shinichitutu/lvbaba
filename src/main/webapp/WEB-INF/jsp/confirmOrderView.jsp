...
<div id="wrapper">
    ...
    <div class="container" style="padding-top: 100px;height: 400px">
        <div style="width: 1300px;margin: 30px auto 0 auto;">
            ...
            <div style="width: 880px;">
                ...
                <div class="orderDetail"
                     style="margin-top: 20px;background-color: white;padding: 10px;border-radius: 10px;">
                    <p>
                    ...
                    <ul class="list-group">
                        ...
                        <c:if test="${requestScope.type eq '1'}">
                            <li class="list-group-item">
                                去程航班号：${requestScope.flightGo.flightCompany}-${requestScope.flightGo.flightNumber}</li>
                            <li class="list-group-item">
                                预计起飞时间：${requestScope.flightdetailGo.fdDate}&nbsp;${requestScope.flightGo.flightDTime}</li>
                            <li class="list-group-item">
                                预计达到时间：${requestScope.flightdetailGo.fdDate}&nbsp;${requestScope.flightGo.flightATime}</li>
                            <li class="list-group-item">
                                回程航班号：${requestScope.flightRe.flightCompany}-${requestScope.flightRe.flightNumber}</li>
                            <li class="list-group-item">
                                预计起飞时间：${requestScope.flightdetailRe.fdDate}&nbsp;${requestScope.flightRe.flightDTime}</li>
                            <li class="list-group-item">
                                预计达到时间：${requestScope.flightdetailRe.fdDate}&nbsp;${requestScope.flightRe.flightATime}</li>
                        </c:if>

                        <c:if test="${requestScope.type eq '2'}">
                            <li class="list-group-item">去程火车车次：${requestScope.trainGo.trNumber}</li>
                            <li class="list-group-item">
                                预计出发时间：${requestScope.traindetailGo.tdDate}&nbsp;${requestScope.trainGo.trDTime}</li>
                            <li class="list-group-item">
                                预计到达时间：${requestScope.traindetailGo.tdDate}&nbsp;${requestScope.trainGo.trATime}</li>
                            <li class="list-group-item">回程火车车次：${requestScope.trainRe.trNumber}</li>
                            <li class="list-group-item">
                                预计出发时间：${requestScope.traindetailRe.tdDate}&nbsp;${requestScope.trainRe.trDTime}</li>
                            <li class="list-group-item">
                                预计到达时间：${requestScope.traindetailRe.tdDate}&nbsp;${requestScope.trainRe.trATime}</li>
                        </c:if>

                        <li class="list-group-item">
                            酒店名称：${requestScope.destinationArea.city}&nbsp${requestScope.hotel.hotelName}</li>
